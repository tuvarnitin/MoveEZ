...
import { acceptBooking, fetchAllBookings, fetchPendingBookingRequests, fetchPendingRequestCount, rejectBooking, requestKyc } from "./partner.contoller.js"
...
partnerRouter.get("/bookings", fetchAllBookings)
