...
import { Card, Button, DocsPreview } from "../../components/index.js";
...
const AdminReviewPartner = () => {
	...
	const handleRejectPartner = async (id) => {
		try {
			...
			const response = await adminService.rejectPartner({
				id,
				rejectionReason,
			});
			...
			<div className="sticky top-0 z-40 backdrop-blur-xl bg-background/80 border-b border-zinc-700">
				<div className="max-w-7xl mx-auto px-4 h-16  flex items-center gap-4">
					<button
						...
						className="w-10 h-10 rounded-full border border-zinc-700 flex items-center justify-center hover:bg-zinc-900 transition cursor-pointer"
					>
						<FaArrowLeft />
					</button>
					...
					>
						...
						>
							...
							<p className="text-sm text-gray-500 mt-2">
								Confirm all informations has been verified.
							</p>
							<div className="flex gap-3 mt-4">
								...
								<Button
									text="Approve"
									onClick={() => handleApprovePartner(data._id)}
									fill={true}
					...
					>
						...
						>
							...
							<div className="flex gap-3 mt-4">
								...
								<Button
									text="Confirm"
									onClick={() => handleRejectPartner(data._id)}
									fill={true}
