    ...
    return (
        <div>
            <motion.label
                ...
                className={`flex items-center justify-between p-4 rounded-xl border cursor-pointer hover:border-background  transition ${file && "border-green-500 hover:border-green-500"} ${error && "border-red-500 hover:border-red-500"}`}
            >
                <div>
