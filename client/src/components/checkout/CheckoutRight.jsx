					...
					{status === "payment" && (
						...
						>
							...
							<motion.button
								...
								className="w-full h-14 bg-zinc-900 hover:bg-black disabled:opacity-30 text-white font-black text-sm rounded-2xl flex items-center justify-center gap-2.5 transition-colors shadow-md mt-auto cursor-pointer"
							>
								{paymentLoading ? (
									<RiLoader2Line
										size={17}
