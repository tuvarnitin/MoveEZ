...
import { PAYMENT_BADGE } from "../constant";
...
const RideCompleted = ({ booking, role }) => {
		...
		>
			<div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
				...
				>
					...
					<button
						onClick={() => navigate("/")}
						className="w-full border border-zinc-700 text-zinc-400 py-3 rounded-2xl text-sm font-semibold hover:bg-zinc-900 transition-colors cursor-pointer"
					>
						Back To Home
					</button>
				</motion.div>
