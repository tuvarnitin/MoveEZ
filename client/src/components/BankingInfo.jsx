...
import { BankInfoInput, Button } from "../components/index.js";
...
const BankingInfo = () => {
	...
	const hanldeAccountHolderChange = useCallback(
		(e) => {
			setErrors((prev) => ({
				...prev,
				accountHolder: "",
	...
	const hanldeAccountNumberChange = useCallback(
		(e) => {
			setErrors((prev) => ({
				...prev,
				accountNumber: "",
	...
	const hanldeIfcsCodeChange = useCallback(
		(e) => {
			setErrors((prev) => ({
				...prev,
				ifscCode: "",
	...
	const hanldeMobileNumberChange = useCallback(
		(e) => {
	...
	const hanldeUpiIdChange = useCallback(
		(e) => {
	...
	return (
		<div>
			<div className="-space-y-0.5 text-center">
				...
				<p className="text-xs text-gray-500 border-b border-gray-300 sm:border-0 pb-2 sm:pb-0">
					Fill you Banking information
				</p>
			</div>
			<div className="space-y-8 mt-6">
				{BANK_FIELDS.map(
					(
						{ label, Icon, value, id, placeholder, onChange, maxLength, error },
						index,
					) => (
						<BankInfoInput
							key={id}
			...
			{responseError && (
				<p className="text-xs text-left ml-2 mt-0.5 text-red-500">
					{responseError}
				</p>
			)}
			<div className="flex items-center gap-2 pl-4 mt-3 justify-center">
				...
				<p className="text-xs text-zinc-400">
					Documents are stored securly and manually verified by our team
				</p>
			</div>
			<Button
				isLoading={isLoading}
