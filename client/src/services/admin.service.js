...
export const adminService = {
    ...
    // Vehicle reviews APIs
    fetchVehicle: (data) => apiClient.get(`/api/admin/reviews/vehicle/${data.id}`),
    approveVehicle: (data) => apiClient.get(`/api/admin/reviews/vehicle/approve/${data.id}`),
    rejectVehicle: (data) => apiClient.post(`/api/admin/reviews/vehicle/reject/${data.id}`, data),
